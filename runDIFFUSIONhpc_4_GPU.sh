...
torchrun --standalone --nproc_per_node=$NB_GPUS main.py Train --run_name $name --batch_size 4 --lr 1e-4 --epochs 50 --save_step 5000 -ddim 50 --plot --dataloader_rr --dataset_handler_config="configs/${name}/dataset_handler_config.yaml"
